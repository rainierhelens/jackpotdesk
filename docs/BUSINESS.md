...
- **2026-08-20:** Official vs last night's Ladder is an append-only ledger (`src/data/ladderReplay.json`). One row per game and official date. First write wins. Seed a short recent window, then keep collecting. Descriptive archive only. Not a forecast scoreboard and not tonight's #1.
