...
/** Vite injects this in the browser. Node scripts (digest, recap) fall back. */
const env =
 ...
 */
export const TIP_JAR_URL = env.VITE_TIP_JAR_URL || "";
